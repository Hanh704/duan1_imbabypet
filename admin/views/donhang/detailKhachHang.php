            ...
            <form action="" method="post">
                <select name="" id="" class="from-group">
                    <?php foreach ($listTrangThaiDonHang as $key => $trangThai): ?>
                        <option  <?=$trangThai['id'] == $donHang['trang_thai_id'] ? 'selected' : '' ?> <?=$trangThai['id'] < $donHang['trang_thai_id'] ? 'disabled' : '' ?>  value="<?= $trangThai['id'] ?>"> <?= $trangThai['ten_trang_thai'] ?></option>
                    <?php endforeach ?>
                </select>
            </form>
           ...
           Đơn hàng :<?= $donHang['ten_trang_thai'] ?>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    <i class="fas fa-cat"></i> Shop thú cưng tungntph48782
                    <small class="float-right">Ngày đặt: <?php
                    $originaDate = $donHang['ngay_dat'];
                    echo date("d/m/Y", strtotime($originaDate));
              ...
              <div class="row invoice-info">
                ...
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  <b>Mã đơn hàng :<?= $donHang['ma_don_hang'] ?></b><br>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <?php $tongTtien += $sanPham['thanh_tien']; ?>
                    <?php endforeach; ?>
                    </tbody>
                  </table>
                </div>
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-6">
                  <p class="lead">Ngày đặt: <?= $donHang['ngay_dat'] ?></p></p>
